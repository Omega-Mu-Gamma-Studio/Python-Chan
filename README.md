...
[![MIT License](https://img.shields.io/badge/License-MIT-green)](https://github.com/Omega-Mu-Gamma-Studio/Python-Chan/blob/main/LICENSE)
...
The **source code** for this project is released under the [MIT License](https://github.com/Omega-Mu-Gamma-Studio/Python-Chan/blob/main/LICENSE).
